...
![App Sections](images/app-sections.png)
...
1. **[Set up your Orderwise session](session-setup.md)** - Configure the e-commerce session
...
- Review the [Log Manager](troubleshooting.md#log-manager) for error details
- Ensure all prerequisites are met before proceeding

---

**Ready to continue?** Proceed to [Session Setup](session-setup.md) to configure your Orderwise e-commerce session.
