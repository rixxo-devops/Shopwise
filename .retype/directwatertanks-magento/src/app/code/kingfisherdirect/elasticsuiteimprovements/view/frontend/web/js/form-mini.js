...
define([
    ...
    $.widget('smileEs.quickSearch', $.mage.quickSearch, {
        ...
        _create: function () {
            ...
            var self = this
            this.autoComplete.hide = function () {
                $.fn.hide.bind(this, arguments)
                self.setAutocompleteVisible(false)
            }
            this.autoComplete.show = function () {
                $.fn.show.bind(this, arguments)
                self.setAutocompleteVisible(true)
            }
        },
            ...
            if (value.trim().length >= parseInt(this.options.minSearchLength, 10)) {
                ...
                this.currentRequest = $.ajax({
                    ...
                    success: $.proxy(function (data) {
                        ...
                        this.autoComplete.html(content).css(clonePosition)
                        this.autoComplete.show()
                        this.responseList.indexList = this.autoComplete.find(this.options.responseFieldElements + ':visible');
                        ...
                        this.responseList.indexList
                            ...
                            .on('mouseenter', function (e) {
                                ...
                                self.element.attr('aria-activedescendant', $(this).attr('id'));
                            })
        ...
        _validateElement: function(event) {
            ...
            var link = selected && selected.querySelector("a");
            if (selected && link) {
        ...
        setAutocompleteVisible: function (isVisible) {
            if (isVisible) {
                document.body.classList.add('search-autocomplete-visible')
                return
            }

            document.body.classList.remove('search-autocomplete-visible')
        }
    });
