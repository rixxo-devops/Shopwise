    ...
    categories: {
        ...
        marketing: {
            services: {
                ...
                getsitecontrol: {
                    label: '<b>Getsitecontrol</b> - remember visitor preferences for widgets',
                    cookies: [
                        { name: /^gsc/ },
                    ]
                },
                        ...
                        },
                        {
                            ...
                            cookieTable: {
                                ...
                                body: [
                                    ...
                                    // salsesfire
                                    { domain: "kingfisherdirect.co.uk", name: "sf_*", description: "Cookies required for search to function provided by third-party platform Salesfire", expiration: "up to 30 days" },
                                    { domain: "kingfisherdirect.co.uk", name: "lscache-sf_*", description: "Cookies required for search to function provided by third-party platform Salesfire", expiration: "up to 30 days" },
                                ]
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            cookieTable: {
                                ...
                                body: [
                                    ...
                                    // getsitecontrol
                                    { domain: "www.kingfisherdirect.co.uk", name: "gsc", description: "This local storage file, installed by Getsitecontrol, contains analytical information about the number of visits to our Website.", expiration: "Per local storage rules" },
                                    { domain: "www.kingfisherdirect.co.uk", name: "gscs", description: "This local storage file, installed by Getsitecontrol for creating an analytics report of the Website’s performance. It contains information about geolocation, device, the number of viewed pages, the source you come to our Website from, how many sessions you had on our Website, the date and time of the last visit.", expiration: "Per local storage rules" },
                                    { domain: "www.kingfisherdirect.co.uk", name: "gscw", description: "This local storage file, installed by Getsitecontrol, collects analytical information about our widgets used on the Website: the statistics of view, submit, closing actions, and start and stop conditions.", expiration: "Per local storage rules" },
                                ],
                            }
                        },
                        {
